...
- `git remote rm origin` - отменяет регистрацию удалённого репозитория  (связь с ним). Это может понадобиться, если вы захотите поменять доступ по протоколу SSH на HTTPS.  
...
- Отправить локальную ветку в удалённый репозиторий — `git push <Имя_ветки>`  
...
## Работа с ветками на практике  (10_Working-with-branches-on-GitHub_th2)  
...
## Работа с pull request  (11_Working-with-pull-request_th3)  
...
## Шпаргалка. Командная работа в Git (cheat-sheet-04)  
