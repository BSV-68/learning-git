...
<nbsp><nbsp><nbsp><nbsp>* Возможно, изменили файл ещё раз. Состояния: `staged`, `modified` (+ `tracked`).  
Обратите внимание: `staged` и `modified` у одного файла, но у разных его версий.  
<nbsp><nbsp><nbsp><nbsp>* Ещё раз выполнили `git add`. Состояние: `staged` (+ `tracked`).  
